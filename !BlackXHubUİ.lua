_G.Key = "M3h#kP6!zG@8sY2bRdQ1xL5cV9tE*F7jW$nAqU+iJ4oNwXmZ"

local keychecked = false
local hwid = nill
local hwidplr = game:GetService("RbxAnalyticsService"):GetClientId()

if _G.Key == "M3h#kP6!zG@8sY2bRdQ1xL5cV9tE*F7jW$nAqU+iJ4oNwXmZ" then
	hwid = "47507BEA-0903-4A23-9B61-485FEA86AF23"
	keychecked = true
end
...
local window = ui.new("Combat Warriors", Players.LocalPlayer.Name, "Customer :")
...
Notification:Notify(
    {Title = "X", Description = "Incorrect Whitelist"},
...
Notification:Notify(
    {Title = "X", Description = "Incorrect Key"},
    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
    {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
end
